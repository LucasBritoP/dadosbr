...
```json
{
  "mcpServers": {
    "dadosbr": {
      ...
      "env": {
        "PYTHONPATH": "C:\\caminho\\para\\DadosBR\\src",
        "DADOSBR_CACHE_DIR": "C:\\caminho\\para\\DadosBR\\.dadosbr\\cache"
      }
    }
  }
}
...
curl -X POST "http://127.0.0.1:8000/admin/cnpj/sync" -H "X-DadosBR-Admin-Token: <TOKEN>"
```
...
Se o DadosBR economizou tempo, ajudou em uma pesquisa ou serviu como base para algum agente, notebook ou produto interno, uma doação voluntária ajuda a manter o projeto evoluindo.

Chave Pix aleatória:

```text
022252e5-ee16-4822-a2c3-02fee31c8e38
```
